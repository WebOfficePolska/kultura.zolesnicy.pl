    ...
    <div class="row">
      ...
      <div class="col-12 col-md-8 col-sm-12">
        ...
        <nav class="navbar navbar-expand-lg navbar-light navbar-custom">            
            ...
            <a class="navbar-brand col-md-1 col-sm-4 col-6 text-center" href="/" style="">Kultura z Olesnicy</a>
            ...
            <div class="collapse navbar-collapse justify-content-center  d-none d-lg-block" id="navbarNavLinks2">
              <ul class="navbar-nav pl-0">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="/kontakt" >AKTUALNOŚCI</a>
                </li>
                ...
                <li class="nav-item dropdown mr-4">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="#">NADCHODZĄCE KONCERTY</a>
                    <a class="dropdown-item" href="#">PONIEDZIAŁKI TOMANA</a>
                    <a class="dropdown-item" href="#">OLEŚNICA ROCK FESTIVAL</a>
                    <a class="dropdown-item" href="#">ARCHIWUM OLEŚNICKIEJ SCENY</a>
                  </div>
                </li>
                ...
                <li class="nav-item dropdown mr-4">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="#">NADCHODZĄCE PROJEKCjE</a>
                    <a class="dropdown-item" href="#">RECENZJA</a>
